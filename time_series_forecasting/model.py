...
class TimeSeriesForcasting(pl.LightningModule):
    ...
    def encode_src(self, src):
        # print('@encode_src 1. src = ', src.detach().cpu().numpy())

        src_start = self.input_projection(src) #.permute(1, 0, 2)

        # print('@encode_src 1. src_start = ', src_start.detach().cpu().numpy())
        ...
        # print('@encode_src 2. src = ', src.detach().cpu().numpy())
    ...
    def forward(self, x):
        ...
        # print('@forward after self.encode_src(src) src = ',src.detach().cpu().numpy())
    ...
    def training_step(self, batch, batch_idx):
        ...
        y_hat = y_hat.view(-1)
        print('@training_step after y_hat.view(-1) y_hat = ', y_hat.detach().cpu().numpy())

        y = trg_out.view(-1)
        print('@training_step after trg_out.view(-1) y = ', y.detach().cpu().numpy())

        print('@training_step unique vals at y = ', len(set(y)))
        print('@training_step unique vals at y_hat = ', len(set(y_hat)))
    ...
    def validation_step(self, batch, batch_idx):
        ...
        y_hat = y_hat.view(-1)
        y = trg_out.view(-1)
        print('@validation_step y_hat = ', y_hat.detach().cpu().numpy())
        print('@validation_step y = ', y.detach().cpu().numpy())

        print('@validation_step unique vals at y = ', len(set(y)))
        print('@validation_step unique vals at y_hat = ', len(set(y_hat)))
    ...
    def test_step(self, batch, batch_idx):
        ...
        print('@test_step y_hat = ', y_hat.detach().cpu().numpy())
        print('@test_step y = ', y.detach().cpu().numpy())

        print('@test_step unique vals at y = ', len(set(y.detach().cpu().numpy())))
        print('@test_step unique vals at y_hat = ', len(set(y_hat.detach().cpu().numpy())))
